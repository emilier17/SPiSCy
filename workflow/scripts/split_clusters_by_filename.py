...
#
# Input : clusters.csv
# Outputs : cluster labels split into individual csv files according to filename
#==================================================================================================================#
...
reader = pd.read_csv(clusters_csv, chunksize=CHUNK_SIZE)
...
for i, chunk in enumerate(reader):
    ...
    for file in filenames:
        ...
        subfile = subfile.drop(columns=["filename", "label_propagation"])
